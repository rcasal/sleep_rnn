...
d_in, batch_size, d_out, d_model, dropout, nhead, encoder_layers, dim_feedforward = 1, 16, 2, 64, 0.1, 8, 2, 1028
...
learning_rate = 1e-4
optimizer_ft = optim.Adam(model_ft.parameters(), lr=learning_rate, betas=(0.9, 0.99), weight_decay=0.005)
...
print('Parameters:')
print('\td_in: {} \n\tbatch_size: {} \n\td_out: {} \n\td_model: {} \n\tdropout: {} \n\tnhead: {} \n\tencoder_layers: {} '
      '\n\tdim_feedforward: {}'.format(d_in, batch_size, d_out, d_model, dropout, nhead, encoder_layers, dim_feedforward))
print('\n')
...
# ------------------
#
model_ft = train_model(model=model_ft, optimizer=optimizer_ft, dataloaders=dataloaders, num_epochs=500, cuda=cuda,
